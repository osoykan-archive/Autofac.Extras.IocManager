...
namespace Autofac.Extras.IocManager
{
    public static class RegistrarExtensions
    {
        ...
        {
            var singletonTypes = AssemblyScanner.FromAssembly(assembly)
        ...
        {
            var transientTypes = AssemblyScanner.FromAssembly(assembly)
                                                .IncludeNonPublicTypes()
        ...
        {
            var lifeTimeScopeTypes = AssemblyScanner.FromAssembly(assembly)
                                                    .IncludeNonPublicTypes()
        ...
        {
            var perRequestTypes = AssemblyScanner.FromAssembly(assembly)
                                                 .IncludeNonPublicTypes()
