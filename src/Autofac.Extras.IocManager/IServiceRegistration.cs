...
namespace Autofac.Extras.IocManager
{
    public interface IServiceRegistration
    {
        ...
        /// <summary>
        ///     Occurs when [on conventional registering].
        /// </summary>
        event EventHandler<OnConventionalRegisteringEventArgs> OnConventionalRegistering;
        ...
        void AddInterceptionCallback(Func<Type, bool> selector, params Type[] intercetorTypes);
